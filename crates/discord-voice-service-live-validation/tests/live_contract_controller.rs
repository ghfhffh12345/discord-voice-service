...
fn evidence_json_captures_receive_side_success_contract() {
    let evidence = LiveValidationEvidence {
        ...
        observer_rtp_buffering_event_count: 0,
        observer_rtp_buffering_total_us: 0,
        observer_rtp_buffering_max_us: 0,
        observer_rtp_speed_change_total_abs_us: 0,
        observer_rtp_speed_change_total_fast_us: 0,
        observer_rtp_speed_change_total_slow_us: 0,
        observer_anomaly_count: 0,
        observer_anomalies: Vec::new(),
        ...
        observer_decoded_audio_short_tempo_window_count: 240,
        observer_decoded_audio_short_tempo_window_fast_count: 0,
        observer_decoded_audio_short_tempo_window_slow_count: 0,
        observer_decoded_audio_short_tempo_window_fastest: None,
        observer_decoded_audio_short_tempo_window_slowest: None,
    ...
    assert_eq!(
        ...
        serde_json::json!({
            ...
            "observer_decoded_audio_short_tempo_window_fast_count": 0,
            "observer_decoded_audio_short_tempo_window_slow_count": 0,
            "observer_decoded_audio_short_tempo_window_fastest": null,
            "observer_decoded_audio_short_tempo_window_slowest": null,
            "dave_transition_count_during_playback": 0,
    ...
    finalize_success_evidence(
        ...
        move |_| {
            ...
            LiveValidationEvidence {
                ...
                observer_decoded_audio_tempo_window_slowest_media_ms: 0,
                observer_decoded_audio_tempo_window_slowest_wall_clock_us: 0,
                observer_decoded_audio_short_tempo_window_count: 0,
                observer_decoded_audio_short_tempo_window_fast_count: 0,
                observer_decoded_audio_short_tempo_window_slow_count: 0,
                observer_decoded_audio_short_tempo_window_fastest: None,
                observer_decoded_audio_short_tempo_window_slowest: None,
