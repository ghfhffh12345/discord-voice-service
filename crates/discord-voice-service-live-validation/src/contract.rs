...
pub struct LiveValidationEvidence {
    ...
    pub observer_rtp_buffering_event_count: u64,
    pub observer_rtp_buffering_total_us: u64,
    pub observer_rtp_buffering_max_us: u64,
    pub observer_rtp_speed_change_total_abs_us: u64,
    pub observer_rtp_speed_change_total_fast_us: u64,
    pub observer_rtp_speed_change_total_slow_us: u64,
...
impl From<&TwilightPlaybackSendEventSnapshot> for PlaybackSendEventEvidence {
    fn from(value: &TwilightPlaybackSendEventSnapshot) -> Self {
        Self {
            ...
            source_media_position_samples: value.source_media_position_samples,
...
impl From<&TwilightPlaybackStabilitySnapshot> for PlaybackStabilityEvidence {
    fn from(value: &TwilightPlaybackStabilitySnapshot) -> Self {
        Self {
            ...
            skipped_source_duration_samples: value.skipped_source_duration_samples,
            ...
            discarded_source_duration_samples: value.discarded_source_duration_samples,
            ...
            stop_discarded_source_duration_samples: value.stop_discarded_source_duration_samples,
            ...
            interruption_discarded_source_duration_samples: value
            ...
            restored_source_duration_samples: value.restored_source_duration_samples,
            ...
            egress_dropped_music_duration_samples: value.egress_dropped_music_duration_samples,
