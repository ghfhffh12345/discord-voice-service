...
`ytmusic-service` refers to https://github.com/ghfhffh12345/ytmusic-service.
Use Serena for project context and Context7 for library/docs context.
Do not modify the `main` branch or main checkout when using git worktrees. Work only in the intended feature worktree.
